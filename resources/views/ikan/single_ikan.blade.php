			...
			<div class="detail-show-deskrip-ikan">
				...
				<form action="/pesanan" method="POST" style="margin-top: 15px;">
					<div class="form-group" style="margin-bottom: 0;">
						<input type="number" name="jumlah" placeholder="Jumlah pembelian" value="{{ old('jumlah') }}" style="height: 26px;padding: 5px;border: none;border-bottom: 2px solid #eb3d32;font-size: 19px;font-weight: 900;color: #eb3d32;outline-style: none;width: 170px;">
